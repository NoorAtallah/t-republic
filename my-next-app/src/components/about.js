...
const IngredientsStorySection = () => {
  ...
  const sectionProgress = adjustedScrollY > 0 && typeof window !== 'undefined' ? (adjustedScrollY % window.innerHeight) / window.innerHeight : 0;
  ...
  return (
    <div className="relative w-full bg-black" style={{ height: `${ingredients.length * 100}vh` }}>
      ...
      {/* Content - uses sticky positioning */}
      <div className="sticky top-0 h-screen flex items-center justify-center text-white z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center h-full px-8 max-w-7xl mx-auto w-full">
